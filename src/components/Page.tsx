...
export default component$(() => {
  return (
    <article id="commit-message-suggestions" class="scroll-mt-16" style="padding-bottom: 7.65625px;">
  <div>
    <header class="relative mb-10 xl:mb-0">
      <div
        ...
        <a class="inline-flex" href="#commit-message-suggestions">
          <time data-datetime="2024-04-01T00:00:00.000Z"
            class="hidden xl:pointer-events-auto xl:block xl:text-2xs/4 xl:font-medium xl:text-white/50">Apr 1,
            2024</time>
        </a>
        ...
        <div class="lg:ml-96 lg:flex lg:w-full lg:justify-end lg:pl-32">
          <div class="mx-auto max-w-lg lg:mx-0 lg:w-0 lg:max-w-xl lg:flex-auto">
            <div class="flex"><a class="inline-flex" href="#commit-message-suggestions"><time
                  data-datetime="2023-04-06T00:00:00.000Z"
                  class="text-2xs/4 font-medium text-gray-500 xl:hidden dark:text-white/50">Apr 6, 2023</time></a></div>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="lg:ml-96 lg:flex lg:w-full lg:justify-end lg:pl-32">
        <div class="mx-auto max-w-lg lg:mx-0 lg:w-0 lg:max-w-xl lg:flex-auto typography" data-mdx-content="true">
          ...
          {/* <p>In the latest release, I've added support for commit message and description suggestions via an integration
            ...
            your changes.</p>
          <p>It's also been a pretty helpful way to remind myself what the hell I was working on at the end of the day
            yesterday when I get back to my computer and realize I didn't commit any of my work.</p>
          ...
          {/* <ul>
            ...
            <li>Improved active project detection to try and ignore file changes triggered by the system instead of the
              user</li>
